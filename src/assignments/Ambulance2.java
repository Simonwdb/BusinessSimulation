 ...
 * @author mctenthij
 */
public class Ambulance2 extends Event {
    Region baseRegion;
    ...
    public Ambulance2(Region baseRegion, RandomStream rng, double serviceTimeRate) {
        currentCust = null;
    ...
    public Ambulance2(Region baseRegion, RandomStream rng, double serviceTimeRate, boolean outside) {
        currentCust = null;
        this.baseRegion = baseRegion;
        serviceTimeGen = new ExponentialGen(rng, serviceTimeRate);
    ...
    public void serviceCompleted(Ambulance2 amb, Accident currentCust) {
